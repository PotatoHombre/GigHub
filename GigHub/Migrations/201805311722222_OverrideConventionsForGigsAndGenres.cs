namespace GigHub.Migrations
{
    ...
    public partial class OverrideConventionsForGigsAndGenres : DbMigration
    {
        public override void Up()
        {
            ...
            DropForeignKey("dbo.Gigs", "Genere_Id", "dbo.Genres");
            ...
            AddForeignKey("dbo.Gigs", "Genere_Id", "dbo.Genres", "Id", cascadeDelete: true);
        }
        ...
        public override void Down()
        {
            ...
            CreateIndex("dbo.Gigs", "Genere_Id");
            CreateIndex("dbo.Gigs", "Artist_Id");
            AddForeignKey("dbo.Gigs", "Genere_Id", "dbo.Genres", "Id");
